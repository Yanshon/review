	...
	<table width="600" border="1">
		...
		<c:forEach items="${requestScope.proList}" var="product" varStatus="num">
			<tr>
				...
				<td><a href="<%=request.getContextPath()%>/ProductServlet?id=${product.id}&type=delete">删除</a>
				<a href="<%=request.getContextPath()%>/ProductServlet?id=${product.id}&type=getById">更新</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
